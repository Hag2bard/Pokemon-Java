...
//        menuBar = new JMenuBar();
        ...
        menuItemFileOpen.addActionListener(e -> {
            ...
            if (loadMap.getMapString() != null) {
                ...
                objectPlace.pokeEditor.mapCreator.repaint();
                final JScrollBar bar = objectPlace.pokeEditor.mapJScrollPane.getVerticalScrollBar();
        ...
        menuItemEditClean.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                objectPlace.mapPanel.getMapLayer1().clean(objectPlace.pokeEditor.getFieldHeight(), objectPlace.pokeEditor.getFieldWidth());
                objectPlace.mapPanel.getMapLayer2().clean(objectPlace.pokeEditor.getFieldHeight(), objectPlace.pokeEditor.getFieldWidth());
            }
        });
