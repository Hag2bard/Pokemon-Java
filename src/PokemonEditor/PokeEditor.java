...
public class PokeEditor implements KeyListener {
    ...
    private JCheckBox btnDeleteBlock;
    ...
    public PokeEditor() {
        ...
        this.mapPanel = new MapPanel(tilePanel, this, logic);
        logic.setMapPanel(mapPanel);
        ...
        bar = mapJScrollPane.getVerticalScrollBar();
        ////////////
        PokeEditorMenu pokeEditorMenu = new PokeEditorMenu(mapPanel, tilePanel,this, logic);
    ...
    private void addButtonBar() {
        ...
        txtFieldAmountOfSelectedBlocks.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                tilePanel.amountOfSelectedBlocks = amount;
        ...
        txtFieldSelectedLayer.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                mapPanel.setChoosedLayer(layer);
    ...
    public void setBtnDeleteBlock(boolean activate) {
        btnDeleteBlock.setSelected(activate);
    }
